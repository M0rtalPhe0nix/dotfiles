...
Follow the preloaded `excalidraw` skill before creating or editing anything. Inspect only the workspace sources identified by the parent agent or directly relevant files needed to understand those sources.
