...
- Claude Code and OpenCode with shared skills and practical safety guardrails. Both include CLAUDE.md maintenance tools, and Claude uses matching plugins for optional mise-managed language servers; no global MCP servers or global AI instruction files are installed.
